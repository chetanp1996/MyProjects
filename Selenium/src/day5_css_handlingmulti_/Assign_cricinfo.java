...
public class Assign_cricinfo {
	...
	public static void main(String[] args) {
	    ...
	    set.get("https://www.espncricinfo.com");
	    
	    
	    List<WebElement> deviceName=set.findElements(By.cssSelector(".ds-bg-fill-navbar>div>div>div>div>div>a"));
